<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('habitaciones.index') }}" :active="request()->routeIs('habitaciones.*')">
                {{ __('Habitaciones') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link href="{{ route('tipos-habitacion.index') }}" :active="request()->routeIs('tipos-habitacion.*')">
                {{ __('Tipo de Habitaciones') }}
            </x-responsive-nav-link>
